...
To solve the kata you..
  1) implement the BaseKataSolution interface
  2) use 'mvn clean install' in the /roman-roulette-solv-java folder to build and test it
  3) and keep trying until you solve it :-)

The kata details can be found online
under http://www.codingkata.org/katas/unit/roman-roulette
