...
public class KataTask
    ...
    private String[][] dict = {{"chick", "woman"}, {"dude", "man"}, {"go postal", "start shooting"},
    ...
    public void start() {
        ...
        l.add(new Sentence(
                ...
                "The policeman was later reported to have said that \"Gibbons was really BLEEP - thank god he didn't BLEEP\"."));
        l.add(new Sentence(
